...
if (isset($_POST['simpan_data'])) {
    ...
    if (empty($namappk) || empty($nipppk)) {
    ?>
        <script type="text/javascript">
            alert('Form yang anda isi belum lengkap!');
            window.location.href = '<?= $url; ?>views/page/master_data/ppk.php';
        </script>
    <?php

        return false;
    } else {
        $simpan = mysqli_query($konek, "INSERT INTO tbl_ppk(namappk, nipppk)
                                        VALUES ('$namappk','$nipppk')");
        if (!$simpan) {
        ?>
            <script type="text/javascript">
...
if (isset($_POST['hapus_data'])) {
    $hapus = mysqli_query($konek, "DELETE FROM tbl_ppk WHERE id='$_POST[id]'");
    if (!$hapus) {
        ?>
        <script type="text/javascript">
...
if (isset($_POST['simpan_perubahan_data'])) {
    ...
    ?>
        ...
        $edit = mysqli_query($konek,"UPDATE tbl_ppk SET namappk='$namappk', nipppk='$nipppk' WHERE id ='$id'");
        if (!$edit) {
        ?>
            <script type="text/javascript">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body">
                                    <table id="example1" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            <?php
                                            $query = mysqli_query($konek, "SELECT * FROM tbl_ppk ORDER BY id DESC");
                                            $no = 1;
                                                ...
                                                <div class="modal fade" id="modal-edit<?= $d['id']; ?>">
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            ...
                                                            <form action="<?= $url; ?>views/page/master_data/ppk.php" method="post">
                                                                <input type="hidden" name="id" value="<?= $d['id']; ?>">
                                                                <div class="modal-body">
                                                                    <div class="form-group">
                                                                        <label>Nama</label>
                                                                        <input type="text" name="namappk" class="form-control" value="<?= $d['namappk'] ?>" placeholder="..." />
                                                                    </div>
                                                                    <div class="form-group">
                                                                        <label>NIP</label>
                                                                        <input type="number" name="nipppk" class="form-control" value="<?= $d['nipppk'] ?>" placeholder="..." />
                    ...
                    <div class="modal-content">
                        ...
                        <form action="<?= $url; ?>views/page/master_data/ppk.php" method="post">
                            <div class="modal-body">
                                <div class="form-group">
                                    <label>Nama</label>
                                    <input type="text" name="namappk" class="form-control" placeholder="..." />
                                </div>
                                <div class="form-group">
                                    <label>NIP</label>
                                    <input type="number" name="nipppk" class="form-control" placeholder="..." />
                                    <small class="text-muted">* Jangan gunakan spasi pada NIP</small>
                                </div>
                            </div>
                            <div class="modal-footer justify-content-between">
