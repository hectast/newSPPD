                    ...
                    <div class="row mb-2">
                        ...
                        <div class="col-sm-6">
                            <ol class="breadcrumb float-sm-right">
                                ...
                                <li class="breadcrumb-item"><a href="<?= $url; ?>views/page/isian/riil.php" class="txc-yellow">Daftar Pengeluaran Riil</a></li>
                        ...
                        <div class="row">
                            <div class="col-sm-4">
                                <div class="form-group">
                                    <select class="form-control select2bs4" name="nospd" style="width: 100%;">
                                        <option value="kosong">-Pilih Nomor SPD/Nama Pelaksana SPD-</option>
                                        <?php
                                        $sqlnospd = mysqli_query($konek, "SELECT * FROM tbl_rinciriil ORDER BY id DESC");

                                        while ($e = mysqli_fetch_array($sqlnospd)) {
                                            echo "<option value='$e[nospd]'>$e[nospd] | $e[laksanaspd]</option>";
                                        }
                                        ?>
                                    </select>
                                </div>
                            ...
                            <div class="col-sm-2">
                                <div class="form-group">
                                    <button type="submit" name="tampilkan" class="btn btn-yellow">Tampilkan</button>
                                </div>
                            </div>
                        </div>
                    </form>
                    <?php
                    if (isset($_GET['nospd']) && $_GET['nospd'] === "kosong") {
                    ?>
                        <script>alert('Pilih Nomor SPD/Nama Pelaksana SPD');</script>
                    <?php
                    } else if (isset($_GET['nospd'])) {
                        $sqlnospd = mysqli_query($konek, "SELECT * FROM tbl_rinciriil WHERE nospd='$_GET[nospd]' ORDER BY id DESC");
                            ...
                            <div class="col-12">
                                <div class="card">
                                    ...
                                    <div class="card-footer">
                                        <button type="submit" name="simpan_data" class="btn btn-success float-right">Simpan</button>
                                    </div>
                                </div>
                            </div>
                        </div>
