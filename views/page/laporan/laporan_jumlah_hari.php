            ...
            <section class="content-header">
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-sm-12">
                            <center>
                                <h5>REKAP LAPORAN SPPD BKP GORONTALO</h5>
                            </center>
                        </div>
                    </div>
                    <br>
                    <form action="cetak_jmlhari.php" method="POST">
                        <div class="row">
                            <div class="col-sm-2">
                            ...
                            <tbody>
                                ...
                                ?>
                                    ...
                                    <tr>
                                        ...
                                        <td><?= $row["lama"]; ?></td>
                                        <td><?= $row["akun"]; ?></td>
                                        <td><?= substr($row["tglspt"], 3, -4); ?></td>
                                        <td><?= substr($row["tglspt"], -4, 4); ?></td>
                                    </tr>
                                <?php
